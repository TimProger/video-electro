    ...
    switch (page) {
      case 1:
        return <div className={s.page__info}>
          <Text size={'bigger'} type={'h2'}>Юридическое лицо</Text>
          <Text size={'small'}>Добавьте информацию о вашей компании, чтобы проводить оплату через кор. счет и полноценно сотрудничить с Video-Electro.</Text>
          <div className={s.page__info__}>
            ...
            <div className={s.profile__content}>
              <div className={s.profile__pages}>
                <div onClick={() => setPage(1)} className={classNames(s.profile__pages__page, {[s.profile__pages__page_active]: page === 1})}>
                  ...
                  <Text size={'medium'}>Личная информация</Text>
                </div>
                ...
                <div onClick={() => setPage(3)} className={classNames(s.profile__pages__page, {[s.profile__pages__page_active]: page === 3})}>
                  ...
                  <Text size={'medium'}>Юридическое лицо</Text>
                </div>
              </div>
