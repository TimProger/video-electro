    ...
    <div className={s.footer}>
      <div className={s.footer__top}>
        <div className={s.footer__top__left}>
          <Text bold size={'bigger'}>Video-<Text bold type={'span'} size={'bigger'} colored={true}>Electro</Text></Text>
        </div>
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td>
                    <Text type={'link'} no_td={true} href={'/catalog'} colored={pathname === "/catalog"}>Профиль</Text>
                  </td>
                  <td>
                    <Text type={'link'} no_td={true} href={'/about'} colored={pathname === "/about"}>Вопросы и ответы</Text>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <Text type={'link'} no_td={true} href={'/profile'} colored={pathname === "/profile"}>Каталог</Text>
                  </td>
                  <td>
                    <Text type={'link'} no_td={true} href={'/orders'} colored={pathname === "/orders"}>Заказы</Text>
                  </td>
                  <td>
                    <Text type={'link'} no_td={true} href={'/company'} colored={pathname === "/company"}>Возврат и обмен</Text>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <Text type={'link'} no_td={true} href={'/faq'} colored={pathname === "/faq"}>О нас</Text>
                  </td>
                  <td>
                    <Text type={'link'} no_td={true} href={'/recovery'} colored={pathname === "/recovery"}>Компания</Text>
                  </td>
                  <td>
