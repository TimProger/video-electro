      ...
      return (
        <div className={cn}
          ...
          {passOpen ? <svg onClick={() => setPassOpen(false)} className={s.input__eye} width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M13.9998 8C13.9998 9.65685 12.6566 11 10.9998 11C9.3429 11 7.99976 9.65685 7.99976 8C7.99976 6.34315 9.3429 5 10.9998 5C12.6566 5 13.9998 6.34315 13.9998 8Z" stroke="#5B74F9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M11.0002 1C6.52257 1 2.73228 3.94288 1.45801 7.99997C2.73226 12.0571 6.52256 15 11.0002 15C15.4778 15 19.2681 12.0571 20.5424 8.00004C19.2681 3.94291 15.4778 1 11.0002 1Z" stroke="#5B74F9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
