          ...
          <div className={s.cardLong__content}>
            ...
            <div className={s.cardLong__content__bottom}>
              ...
              <div className={s.cardLong__content__bottom__btns}>
                ...
                {basket ? <Button onClick={()=>onRemoveFavs(product.id)}
                                size={'medium'}
                                style={'borderless'}>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                {!basket ? <Button disabled={product.product_more[0].availability <= 0} size={'medium'} style={'filled'}>
      ...
      return (
        <div className={classNames(s.card, className)} key={key}>
          ...
          <div className={s.card__btns}>
            ...
            <Button disabled={product.product_more[0].availability <= 0} size={'medium'} style={'filled'}>
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
